...
case 'infobot':
if (!iselaina) return sendButMessage(from, lang.noregis(pushname), `Klik Button Untuk Verify`, [{buttonId: '.daftar',buttonText: {displayText: `Daftar`,},type: 1,}], {quoted: fgif});
			reply("Update bot selanjutnya silahkan cek YouTube Pak Zainal Dev's")
break
case 'owner':{
if (!iselaina) return sendButMessage(from, lang.noregis(pushname), `Klik Button Untuk Verify`, [{buttonId: '.daftar',buttonText: {displayText: `Daftar`,},type: 1,}], {quoted: fgif});
...
case 'ppcp': 
       ...
       cewe = await getBuffer(anu.result.cewe_image)
		    pll = `Ini Untuk  **`
   sendButImage(from, pll, `Pak Zainal Dev's  2022`, cewe, [                      
          {
...
if (q == computer) {
reply(`*Subscribe Yt Pak Zainal Dev's*\n\nPertandingan Seri!`)
} else if (q == 'batu') {
if (computer == 'gunting') {
reply(`*Subscribe Yt Pak Zainal Dev's*\n\n You: Batu\n Computer: Gunting\n\nCongrats You win!`)
} else {
